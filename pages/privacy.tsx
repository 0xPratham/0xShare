    ...
    return (
        <VStack mt={10}>
            ...
            <Stack overflow="hidden" maxW="4xl">
                <Text fontSize="xl">
                    This privacy policy sets out how 0xShare uses and protects
                    any information that you give 0xShare when you use this
                    website.
                </Text>
                <Text style={style} fontSize="xl">
                    ...
                    by which you can be identified when using this website, and
                    then you can be assured that it will only be used in
                    accordance with this privacy statement.
                </Text>
                <Text style={style} fontSize="xl">
                    0xShare may change this policy from time to time by updating
