...
const privacyPolicy = () => {
    ...
    return (
        <>
            <Seo title="0xShare - Terms & Conditions" url="/terms" />
            <VStack mt={10}>
                ...
                <Stack overflow="hidden" maxW="4xl">
                    <Text fontSize="xl">
                        ...
                        of the pages comprising the website (“website”) to
                        visitors (“visitors”) (cumulatively referred to as “you”
                        or “your” hereinafter) subject to the terms and
                        conditions set out in these website terms and
                        conditions, the privacy policy and any other relevant
                    ...
                    <Text style={style} fontSize="xl">
                        ...
                        which together with our privacy policy govern 0xShare
                    ...
                    <Text style={style} fontSize="xl">
                        ...
                        <br />
                        2. Neither we nor any third parties provide any warranty
                        ...
                        such information and materials may contain inaccuracies
                        or errors and we expressly exclude liability for any
                        such inaccuracies or errors to the fullest extent
                        permitted by law.
                        <br />
                        3. Your use of any information or materials on this
                        ...
                        requirements.
                        <br /> 4. This website contains material which is owned
                        by or licensed to us. This material includes, but is not
                        ...
                        <br /> 5. All trademarks reproduced in this website
                        which are not the property of, or licensed to, the
                        operator are acknowledged on the website.
                        <br /> 6. Unauthorized use of this website may give rise
                        to a claim for damages and/or be a criminal offense.
                        <br /> 7. From time to time this website may also
                        ...
                        another website or document without 0xShare’s prior
                        written consent.
                        <br /> 9. Your use of this website and any dispute
